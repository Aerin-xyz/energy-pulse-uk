...
const explainers: Record<string, Explainer> = {
  '/uk-electricity-mix': {
    ...
    metaTitle: 'UK Electricity Mix Today | Live GB Generation by Source',
    description: 'Live Great Britain electricity mix today: generation by source, demand, renewables, gas, wind, solar, nuclear, imports and carbon intensity.',
    eyebrow: 'Electricity mix explained',
    intro: 'The UK electricity mix is the blend of sources generating power at a given moment. EnergyMix.info focuses on live Great Britain electricity data and explains how wind, solar, gas, nuclear, imports, storage and demand shape the grid today.',
    shortAnswer: 'The UK electricity mix today changes as demand rises and falls and weather-dependent generation such as wind and solar moves up or down. Most live data covers Great Britain: England, Scotland and Wales. Northern Ireland is part of the UK but operates in a separate electricity market.',
    sections: [
      { heading: 'UK electricity mix right now', body: ['Use the live dashboard to see the current generation mix, demand, carbon intensity, renewables share, gas output, nuclear generation and interconnector flows. These values change as settlement periods update and source systems publish fresh data.', 'The build-time snapshot on this page gives crawlers and non-JavaScript readers a source-backed summary, while the interactive dashboard refreshes in the browser from public grid and carbon-intensity sources.'] },
    ...
    related: [{ to: '/', label: 'Live dashboard' }, { to: '/today', label: 'UK electricity mix today' }, { to: '/carbon-intensity', label: 'Carbon intensity' }, { to: '/uk-electricity-generation-live', label: 'Generation live' }],
    liveFocus: 'mix',
  },
  '/carbon-intensity': {
    slug: '/carbon-intensity',
    title: 'UK Carbon Intensity',
    metaTitle: 'UK Carbon Intensity Today | Live Grid CO₂/kWh',
    description: 'Live UK carbon intensity today: current GB grid CO₂/kWh, why it changes, cleaner electricity windows and practical timing for flexible demand.',
    ...
    sections: [
      { heading: 'Carbon intensity right now', body: ['The live dashboard shows the latest available carbon-intensity estimate alongside demand and generation. Compare it with the generation mix to understand what is driving the number.', 'EnergyMix.info pairs the live estimate with source-freshness notes because carbon-intensity, generation and demand feeds can update on different schedules.'] },
