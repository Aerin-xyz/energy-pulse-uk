...
const footerLinks = [
  ...
  { to: '/uk-wind-power-today', label: 'Wind today' },
  { to: '/uk-solar-power-today', label: 'Solar today' },
  { to: '/renewables-share-today', label: 'Renewables today' },
  { to: '/carbon-intensity-today', label: 'Carbon today' },
  { to: '/gas-share-of-electricity', label: 'Gas share' },
